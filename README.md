...
This repository contains Task 1 of the DevOps Internship:
Automating Code Deployment using a complete CI/CD pipeline powered by GitHub Actions and DockerHub.
...
DockerHub	Host the pushed Docker images
...
This project is part of the DevOps Internship – Task 1: Automate Code Deployment Using CI/CD Pipeline.
The task helped me understand real-world DevOps processes, CI/CD tools, and Docker-based deployment workflows.
